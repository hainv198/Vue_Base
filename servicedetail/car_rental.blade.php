                        ...
                        <div id="top-functions-area" class="top-functions-area">
                            <div class="flt-item to-left group-on-mobile">
                                ...
                                <div class="wrap-selectors">
                                    <form action="{{route('car')}}" name="frm-refine" method="get" class="d-flex">
                                        <div data-title="Dịch vụ:" class="selector-item">
                                            <select name="status" class="selector">
                                                <option value="">{{__('Sản phẩm & dịch vụ')}}</option>
                                                <option value="1">{{__('Dài hạn')}}</option>
                                                <option value="2">{{__('Ngắn hạn')}}</option>
                                            </select>
                                        </div>
                                        <div data-title="Hãng xe:" class="selector-item">
                                            <select name="car_base" class="selector" style="height: 200px">
                                        ...
                                        <div data-title="Số ghê:" class="selector-item">
                                            <select name="seats" class="selector">
                                                ...
                                                <option value="5">5 {{__('Chỗ')}}</option>
                                                <option value="7">7 {{__('Chỗ')}}</option>
                                                <option value="8">8 {{__('Chỗ')}}</option>
                                                <option value="10">10 {{__('Chỗ')}}</option>
                                                <option value="16">16 {{__('Chỗ')}}</option>
                                            </select>
                                        </div>
                                            ...
                                            <div class="contain-product pr-detail-layout">
                                                ...
                                                <div class="info">
                                                    ...
                                                    <ul class="text-left list-detail-info-car">
                                                        <li>
                                                                <span>
                                                                    {{$item->description != '' ? $item->description : $item->description_default}}
                                                                </span>
                                                        </li>
                                                        ...
                                                        <li>
                                                             <span>
                                                                 @if($item->status == 1)
                                                                     <i class='bx bx-time'></i> {{__('Dài hạn')}}
                                                                 @endif
                                                                 @if($item->status == 2)
                                                                     <i class='bx bx-time'></i> {{__('Ngắn hạn')}}
                                                                 @endif
                                                             </span>
                                                        </li>
