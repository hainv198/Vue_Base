                        ...
                        <div id="top-functions-area" class="top-functions-area">
                            <div class="flt-item to-left group-on-mobile">
                                ...
                                <div class="wrap-selectors">
                                    <form action="{{route('sales-equipment')}}" name="frm-refine" method="get" class="d-flex">

                                        <div data-title="Hãng xe:" class="selector-item">
                                            <select name="status" class="selector">
                                                <option value="">{{__('Loại thiêt bị')}}</option>
                                                <option value="3">{{__('Thiết bị văn phòng')}}</option>
                                                <option value="4">{{__('Máy phát tín hiệu')}}</option>
                                                <option value="5">{{__('Thiết bị gia dụng')}}</option>
                                                <option value="6">{{__('Thiết bị y tế')}}</option>
                                            </select>
                                        </div>
                                            ...
                                            <div class="contain-product pr-detail-layout">
                                                <div class="product-thumb">
                                                    <a href="#" class="link-to-product">
                                                        <img src="{{'/img/thumbnails/sales/'.$item->id.'/'.$item->file_path}}" alt="dd" width="270"
                                                ...
                                                <div class="info">
                                                    <h4 class="product-title">
                                                        @if(app()->getLocale() != 'en')
                                                            <a class="pr-name">{{$item->name}}</a>
                                                        @endif
                                                        @if(app()->getLocale() == 'en')
                                                                <a class="pr-name">{{$item->name_en}}</a>
                                                        @endif
                                                    ...
                                                    <ul class="text-left list-detail-info-car">
                                                        ...
                                                        <li>
                                                            @if($item->status == 3)
                                                            <span>{{__('Thiết bị văn phòng')}}</span>
                                                            @elseif($item->status == 4)
                                                            <span>{{__('Máy phát tín hiệu')}}</span>
                                                            @elseif($item->status == 5)
                                                            <span>{{__('Thiết bị gia dụng')}}</span>
                                                            @elseif($item->status)
                                                            <span>{{__('Thiết bị y tế')}}</span>
                                                            @endif
                                                        </li>
