                        ...
                        <div id="top-functions-area" class="top-functions-area">
                            <div class="flt-item to-left group-on-mobile">
                                ...
                                <div class="wrap-selectors">
                                    <form action="{{route('sales-car')}}" name="frm-refine" method="get" class="d-flex">
                                        ...
                                        <li class="product-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="contain-product pr-detail-layout">
                                                <div class="product-thumb">
                                                    <a href="{{route('detail-sales-car',  $item->id)}}" class="link-to-product">
                                                        @if(!$item->saleImages->isEmpty())
                                                            <img src="{{Storage::disk('local')->url($item->saleImages->first()->image)}}" alt="dd" width="270" height="270" class="product-thumnail">
                                                        @endif
                                                    </a>
                                                </div>
                                                <div class="info">
                                                    <h4 class="product-title">
                                                        <a class="pr-name" href="{{route('detail-sales-car',  $item->id)}}">
                                                            {{$item->name}}
                                                        </a>
                                                    </h4>
